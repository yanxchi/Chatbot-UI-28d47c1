...
AS $$
DECLARE
  project_url TEXT := 'https://zxdigakrugkrakfkluhw.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp4ZGlnYWtydWdrcmFrZmtsdWh3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzk4MDc3OCwiZXhwIjoyMDIzNTU2Nzc4fQ._Mi2u6xVE3Tyqup2VrBI-BcxL0A43Zle5vlasKI39yQ'; -- full access needed for http request to storage
